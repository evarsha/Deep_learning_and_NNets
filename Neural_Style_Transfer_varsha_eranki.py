...
# 
# In this project, we will use VGG-19 CNN architecture to implement Neural Style Transfer. This algorithm was created by Gatys et al. (2015) (https://arxiv.org/abs/1508.06576). 
# 
...
# **Exercise**: Implement compute_style_cost(...) function. It simply calls your `compute_layer_style_cost(...)` several times, and weights their results using the values in `STYLE_LAYERS`. Read over it to make sure you understand what it's doing. 
# 
# **Instructions:**
# 
...
# Let's set up the Adam optimizer in TensorFlow using a learning rate of 2.0.  [See reference](https://www.tensorflow.org/api_docs/python/tf/train/AdamOptimizer)

# In[73]:


# define Adam optimizer (1 line)
